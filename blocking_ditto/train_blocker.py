...
def train(hp):
    ...
    for example in reader.get_examples(hp.valid_fn):
        sentences1_val.append(example.texts[0])
        sentences2_val.append(example.texts[1])
        scores_val.append(example.label)
    
    evaluator = EmbeddingSimilarityEvaluator(sentences1 = sentences1_val, sentences2 = sentences2_val, scores=scores_val)
